...
const events = [
  ...
  },
  {
    ...
    city: "Manchester",
    location: "Manchester Exhibition Center",
  ...
  },
  {
    ...
    city: "Manchester",
    location: "Manchester Waterfront Park",
  ...
  },
  {
    ...
    city: "Birmingham",
    location: "Birmingham Convention Center",
    date: "2030-11-15T00:00:00.000Z",
  ...
  },
  {
    ...
    city: "Birmingham",
    location: "Birmingham Science Center",
  ...
  },
  {
    ...
    city: "Manchester",
    location: "Manchester Epicurean Institute",
    date: "2030-12-02T00:00:00.000Z",
  ...
  },
  {
    ...
    slug: "literary-salon",
    city: "Birmingham",
    location: "Birmingham & Co. Bookstore",
...
async function main() {
  ...
  for (const event of events) {
    const result = await prisma.eventyEvent.upsert({
      where: { id: event.id },
      update: {},
      create: event,
    });
